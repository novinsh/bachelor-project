function [] = show_map(ax, bounds, map_img_filename, plotlabels)
...
xlabel(ax, plotlabels.xaxis) % 'Longitude (^o)'
ylabel(ax, plotlabels.yaxis) % 'Latitude (^o)'
title(ax, plotlabels.title) % 'OpenStreetMap osm file'
