function [] = plot_way(ax, parsed_osm, plotlabels, map_img_filename)
...
show_ways(ax, bounds, node, way, map_img_filename, plotlabels);

function [] = show_ways(hax, bounds, node, way, map_img_filename, pl)
show_map(hax, bounds, map_img_filename, pl)
